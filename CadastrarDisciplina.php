...
//Caio script
	...
	{
		debug_to_console("deslogou do sistema - ARQUIVO:CadastrarDisciplina.php");
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h1 class="page-header">Cadastrar Disciplina&nbsp;
              ...
              <ul class="list-group" style="width: 350px;">
                ...
                <li class="list-group-item">Língua Portuguesa</li>

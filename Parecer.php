...
<head>
	...
	<meta name="description" content="Arquivo de Parecer do Diario de Classe">
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" style="min-height: 100vh; width: 100%; background-color: white;" >
			<div id="begin" class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-6">
						<h2 class="page-header">Parecer</h2	>
						</div>
			...
			<form role="form">
				<div class="row">
					<div class="col-lg-6">
						<div class="panel panel-purple" >
							...
							<div class="panel-body" style="height:550px;">
								<div class="thumbnail scrollable-menu-xl" role="menu" style="background-color: rgba(131,105,176,0.3); height:520px;">
					...
					<div id="historico" class="col-lg-6">
							<div class="panel panel-purple" >
								<div class="panel-heading">
									<h3 class="panel-title">Histórico de Parecer</h3>
								</div>
								<div class="panel-body" style="height:300px;">
									<div class="thumbnail scrollable-menu" role="menu" style="background-color: rgba(131,105,176,0.3); height:275px;">

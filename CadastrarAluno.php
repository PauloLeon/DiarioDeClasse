...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">
          <img src="../DiarioDeClasse/imagem/site/diario-de-classe.png" class="img-responsive" style="width:150px;">
        </a>
      </div>
      <!-- Top Menu Items -->
              ...
              <div class="col-md-8">
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" draggable="true" action="CadastrarAluno.php" method="get">
  ...
  <div class="modal fade" id="incluirModal">
          ...
          <div class="thumbnail" style="background-color: ghostwhite;">
            <form role="form" action="CadastrarAluno.php" method="get">
              <div class="form-group" draggable="true" style="margin-bottom: 2px;">
                <label class="control-label" for="text">Turma
                  <br>
                </label>
              </div>
              ...
              <!-- /input-group -->
              <div class="form-group">
                <label class="control-label" for="exampleInputPassword1" style="margin-bottom: 10px;">Nome do Aluno<br></label>
                <input class="form-control" id="exampleInputPassword1" placeholder="Entre com o nome do Aluno" type="text" name="inputNome" value="<?=$varNome;?>">
              </div>
              <div class="form-group">
                <div class="form-group " draggable="true" style="margin-bottom: 2px;">
                  <label class="control-label" for="text">Incluir Disciplinas
                    <br>
                  </label>
                </div>
    ...
    <!-- /.modal -->
    <!-- Modal de Edição ---------------------------------------------------------------------------------->
    <div class="modal fade" id="editModalTurma" tabindex="-1" role="dialog" aria-labelledby="modalTurma" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
    ...
    <!-- Modal de Edição ---------------------------------------------------------------------------------->
    <div class="modal" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="top:1%">
      <div class="modal-dialog">
        <div class="modal-content">
          <!--style="width:500px;  margin-left: 50px; margin-top: 87px;">-->
          <div id="modalFinal" class="modal-body">
            <form class="form-horizontal" role="form" draggable="true" action="CadastrarAluno.php" method="get">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputIdEdit" name="inputIdEdit" style="display:none" value="<?=$varIdEdit;?>" />
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputNomeEdit" name="inputNomeEdit" value="<?=$varNomeEdit;?>" />
                </div>
              </div>
              <div class="modal-footer">
